...
abstract class Repository {
    ...
    private static function wrapFieldValueWithColon($fieldValue) {
        return ':' . $fieldValue;
    }

    private static function wrapFieldNameForUpdate($fieldName) {
        return self::wrapFieldNameInQuotes($fieldName) . ' = ' . self::wrapFieldValueWithColon($fieldName);
    }
    ...
    public function add($entity) {
        ...
        $entityFieldValuesString = implode(", ", array_map(['self', 'wrapFieldValueWithColon'], $entityFields));
    ...
    public function getById($id) {
        ...
        $idFieldCondition = self::wrapFieldNameForUpdate($idFieldName);
    ...
    public function update($id, $entity) {
        $entityName = $this->getEntityName();
        $entityFields = $this->getEntityFields();
        $entityFieldAssignments = implode( ', ', array_map(['self', 'wrapFieldNameForUpdate'], $entityFields));
        $idFieldName = $this->getIdName();
        $idFieldCondition = self::wrapFieldNameForUpdate($idFieldName);
        // Prevent updating id
